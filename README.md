...
|----------------------------------------|--------------------------------------------------------------------------------------------------------------|-------------------------|------------------------|---------|
| Get products                           | Gets the list of products                                                                                    | /products [GET]         | none                   |[sample](myvinos-integration-api#-get-products)         |
| Create access token                    | Creates an access token                                                                                      | /tokens  [POST]         | none                   |[sample](myvinos-integration-api#-create-access-token)|

...
| Create access token                    | Creates an access token, using the auth payload generated by logging into ID-IO (see above)                  | /tokens  [POST]         | none                   |[sample](#create-access-token)|
